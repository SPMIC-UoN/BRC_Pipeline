...
${FSLDIR}/bin/fslmaths ${WD}/SEdivGRE.nii.gz -mas ${T1wFolder}/preprocess/T1_biascorr_brain_mask.nii.gz ${WD}/SEdivGRE_brain.nii.gz
...
${FSLDIR}/bin/fslmaths ${WD}/SEdivGRE_brain_thr_s5.nii.gz -div ${WD}/SEdivGRE_brain_thr_roi_s5.nii.gz -mas ${T1wFolder}/preprocess/T1_biascorr_brain_mask.nii.gz ${WD}/SEdivGRE_brain_bias.nii.gz

${FSLDIR}/bin/fslmaths ${WD}/SpinEchoMean.nii.gz -mas ${T1wFolder}/preprocess/T1_biascorr_brain_mask.nii.gz -div ${WD}/SEdivGRE_brain_bias.nii.gz ${WD}/SpinEchoMean_brain_BC.nii.gz

${FSLDIR}/bin/fslmaths ${WD}/GRE.nii.gz -mas ${T1wFolder}/preprocess/T1_biascorr_brain_mask.nii.gz -div ${WD}/SpinEchoMean_brain_BC.nii.gz ${WD}/SE_BCdivGRE_brain.nii.gz
...
#Check GM segment exist or no
if [ `$FSLDIR/bin/imtest $T1wFolder/seg/tissue/multi_chan/T1_mc_GM` = 1 ] ; then
    GMseg="$T1wFolder/seg/tissue/multi_chan/T1_mc_GM"
elif [[ `$FSLDIR/bin/imtest $T1wFolder/seg/tissue/sing_chan/T1_pve_GM` = 1 ]]; then
    GMseg="$T1wFolder/seg/tissue/sing_chan/T1_pve_GM"
fi
...
${FSLDIR}/bin/fslmaths ${WD}/GRE_grey_s5.nii.gz -div ${WD}/GRE_greyroi_s5.nii.gz -mas ${GMseg} -dilall -mas ${T1wFolder}/preprocess/T1_biascorr_brain_mask.nii.gz ${WD}/GRE_bias_raw.nii.gz
...
${FSLDIR}/bin/fslmaths ${WD}/GRE_bias_raw_s5.nii.gz -div ${WD}/GRE_bias_roi_s5.nii.gz -mas ${T1wFolder}/preprocess/T1_biascorr_brain_mask.nii.gz ${WD}/GRE_bias.nii.gz
