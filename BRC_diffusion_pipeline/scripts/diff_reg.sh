...
${FSLDIR}/bin/flirt -in ${datadir}/nodif_brain -ref ${T1dir}/preprocess/T1_biascorr_brain -dof 6 -omat ${regdir}/lin/diff2std_init.mat

${FSLDIR}/bin/flirt -in ${datadir}/nodif_brain -ref ${T1dir}/preprocess/T1_biascorr_brain -init ${regdir}/lin/diff2std_init.mat -cost bbr -bbrtype global_abs -dof 6 \
                                               -wmseg ${regdir}/lin/T1_wmseg -out ${regdir}/lin/diff_2_T1 -omat ${regdir}/lin/diff_2_T1.mat
...
${FSLDIR}/bin/applywarp --rel --interp=spline --in=$FSLDIR/data/standard/MNI152_T1_2mm --ref=${datadir}/nodif_brain --warp=${T1dir}/reg/nonlin/std_2_T1_warp_field \
